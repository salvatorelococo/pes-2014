...
Essi possono assumere i valori da `0000000` a `1010010`, corrispondenti alle esultanze da `0` a `82` (in totale 83 esultanze).
...
### ALTEZZA (`0x58`, `88`)
Per l'altezza vengono utilizzati i `bit n° 6, 5, 4, 3, 2, 1, 0` bit del byte `0x58`.  
